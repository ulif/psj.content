# -*- coding: utf-8 -*-
# Tests for psj_issue_container module.
#
...
from psj.content.psj_issue_container import (
    IPSJIssueContainer, PSJIssueContainer,
    )
from psj.content.testing import INTEGRATION_TESTING, FUNCTIONAL_TESTING


class PSJIssueContainerUnitTests(unittest.TestCase):

    def test_iface(self):
        # make sure we fullfill all interface contracts
        obj = PSJIssueContainer()
        verify.verifyClass(IPSJIssueContainer, PSJIssueContainer)
        verify.verifyObject(IPSJIssueContainer, obj)


class PSJIssueContainerIntegrationTests(unittest.TestCase):
    ...
    def test_adding(self):
        # we can add PSJIssueContainer instances
        self.folder.invokeFactory(
            'psj.content.issuecontainer', 'doc1',
            title=u'My Doc', description=u'My description.',
            psj_title=u'My Title', psj_subtitle=u'My Subtitle',
            psj_publication_year=u"2014",
            psj_issue_number=u'My Identifier',
            )
        d1 = self.folder['doc1']
        self.assertTrue(IPSJIssueContainer.providedBy(d1))
        ...
        self.assertEqual(d1.psj_issue_number, u'My Identifier')

    def test_editing(self):
        # we can modify PSJIssueContainers. Changes are reflected.
        self.folder.invokeFactory(
            'psj.content.issuecontainer', 'doc1',
            title=u'My doc', description=u'My description.',
            psj_title=u'My title', psj_subtitle=u'My Subtitle',
        ...
        d1.psj_issue_number = u'My changed identifier'
        ...
        self.assertEqual(d1.psj_issue_number, u'My changed identifier')

    def test_fti(self):
        # we can get factory type infos for base docs
        fti = queryUtility(IDexterityFTI, name='psj.content.issuecontainer')
    ...
    def test_schema(self):
        ...
        self.assertEqual(IPSJIssueContainer, schema)

    def test_factory(self):
        # our fti provides a factory for PSJIssueContainer instances
        fti = queryUtility(IDexterityFTI, name='psj.content.issuecontainer')
        factory = fti.factory
        new_obj = createObject(factory)
        self.assertTrue(IPSJIssueContainer.providedBy(new_obj))

    def test_views(self):
        # we can get a regular and a special view for added issuecontainers
        self.folder.invokeFactory(
            'psj.content.issuecontainer', 'doc1',)
        d1 = self.folder['doc1']
    ...
    def test_searchable_text(self):
        ...
        self.folder.invokeFactory(
            ...
            psj_title=u'Baz', psj_subtitle=u'Furor', psj_issue_number=u'Bar',
            psj_publication_year=u'2014',
            )
        d1 = self.folder['doc1']
        self.assertEqual(
    ...
    def test_title_indexed(self):
        # titles of issuecontainers are indexed (also after change)
        self.folder.invokeFactory(
            'psj.content.issuecontainer', 'doc1', title=u'My DocTitle',
            psj_issue_number=u'Bar',)
        d1 = self.folder['doc1']
    ...
    def test_description_indexed(self):
        # descriptions of issuecontainers are indexed (also after change)
        self.folder.invokeFactory(
            'psj.content.issuecontainer', 'doc1',
            description=u'My DocDescription', psj_issue_number=u'Bar')
        d1 = self.folder['doc1']
...
class PSJIssueContainerBrowserTests(unittest.TestCase):
    ...
    def create_doc(self):
        ...
        portal.invokeFactory(
            'psj.content.issuecontainer', 'myeditdoc',
            title=u'My Edit Doc', description=u'My description.',
            psj_title=u'My Title', psj_subtitle=u'My Subtitle',
            psj_publication_year=u'Year No 1',
            psj_issue_number=u'My identifier',
            )
        import transaction
        transaction.commit()
    ...
    def test_add(self):
        ...
        add_link = self.browser.getLink('PSJ Issue Container')
        self.assertEqual('psj-content-issuecontainer', add_link.attrs['id'])
        add_link.click()
        ...
        self.browser.getControl(label='Nr.').value = 'My Identifier'
    ...
    def test_edit(self):
        ...
        self.browser.getControl(label='Nr.').value = 'Other Identifier'
        self.browser.getControl("Save").click()
