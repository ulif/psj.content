# -*- coding: utf-8 -*-
# Tests for psj_retro_mag_container module.
#
...
from psj.content.psj_retro_mag_container import (
    IPSJRetroMagazineContainer, PSJRetroMagazineContainer,
    )
from psj.content.testing import INTEGRATION_TESTING, FUNCTIONAL_TESTING


class PSJRetroMagazineContainerUnitTests(unittest.TestCase):
...
class PSJRetroMagazineContainerIntegrationTests(unittest.TestCase):
    ...
    def test_adding(self):
        # we can add PSJRetroMagazineContainer instances
        self.folder.invokeFactory(
            'psj.content.retromagcontainer', 'doc1',
        ...
        d1 = self.folder['doc1']
        self.assertTrue(IPSJRetroMagazineContainer.providedBy(d1))
    ...
    def test_editing(self):
        # we can modify PSJRetroMagazineContainers. Changes are reflected.
        self.folder.invokeFactory(
            'psj.content.retromagcontainer', 'doc1',
            title=u'My doc', description=u'My description.',
            psj_title=u'My title', psj_subtitle=u'My Subtitle',
    ...
    def test_fti(self):
        ...
        fti = queryUtility(IDexterityFTI, name='psj.content.retromagcontainer')
    ...
    def test_schema(self):
        ...
        self.assertEqual(IPSJRetroMagazineContainer, schema)

    def test_factory(self):
        # our fti provides a factory for PSJRetroMagazineContainer instances
        fti = queryUtility(IDexterityFTI, name='psj.content.retromagcontainer')
        factory = fti.factory
        new_obj = createObject(factory)
        self.assertTrue(IPSJRetroMagazineContainer.providedBy(new_obj))
    ...
    def test_title_indexed(self):
        ...
        self.folder.invokeFactory(
            'psj.content.retromagcontainer', 'doc1', title=u'My DocTitle',
            psj_urn=u'Bar',)
        d1 = self.folder['doc1']
...
class PSJRetroMagazineContainerBrowserTests(unittest.TestCase):
    ...
    def create_doc(self):
        ...
        portal.invokeFactory(
            'psj.content.retromagcontainer', 'myeditdoc',
