# -*- coding: utf-8 -*-
# Tests for psj_basereview module.
#
...
from psj.content.psj_basereview import (
    IBaseReview, BaseReview,
    )
...
class BaseReviewUnitTests(unittest.TestCase):

    def test_iface(self):
        # make sure we fullfill all interface contracts
        obj = BaseReview()
        verify.verifyClass(IBaseReview, BaseReview)
        verify.verifyObject(IBaseReview, obj)


class BaseReviewIntegrationTests(unittest.TestCase):
    ...
    def test_adding(self):
        # we can add BaseReview instances
        ...
        d1 = self.folder['doc1']
        self.assertTrue(IBaseReview.providedBy(d1))
    ...
    def test_editing(self):
        # we can modify BaseReviews. Changes are reflected.
        self.folder.invokeFactory(
            'psj.content.basereview', 'doc1',
            title=u'My doc', description=u'My description.',
            psj_title=u'My title', psj_subtitle=u'My Subtitle',
    ...
    def test_fti(self):
        ...
        fti = queryUtility(IDexterityFTI, name='psj.content.basereview')
    ...
    def test_schema(self):
        ...
        self.assertEqual(IBaseReview, schema)

    def test_factory(self):
        # our fti provides a factory for BaseReview instances
        fti = queryUtility(IDexterityFTI, name='psj.content.basereview')
        factory = fti.factory
        new_obj = createObject(factory)
        self.assertTrue(IBaseReview.providedBy(new_obj))

    def test_views(self):
        # we can get a regular and a special view for added basereviews
        self.folder.invokeFactory(
            'psj.content.basereview', 'doc1',)
        d1 = self.folder['doc1']
    ...
    def test_title_indexed(self):
        # titles of basereviews are indexed (also after change)
        self.folder.invokeFactory(
            'psj.content.basereview', 'doc1', title=u'My DocTitle',
            psj_doi=u'Bar',)
        d1 = self.folder['doc1']
    ...
    def test_description_indexed(self):
        # descriptions of basereviews are indexed (also after change)
        self.folder.invokeFactory(
            'psj.content.basereview', 'doc1',
...
class BasedocBrowserTests(unittest.TestCase):
    ...
    def create_doc(self):
        ...
        portal.invokeFactory(
            'psj.content.basereview', 'myeditdoc',
    ...
    def test_add(self):
        ...
        add_link = self.browser.getLink('PSJ Base Review')
        self.assertEqual('psj-content-basereview', add_link.attrs['id'])
        add_link.click()
