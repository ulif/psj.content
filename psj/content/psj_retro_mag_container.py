...
#  MA 02111-1307 USA.
#
"""Dexterity retro magazine container type for PSJ.
...
class IPSJRetroMagazineContainer(model.Schema):
    """A PSJ base.
    """
...
class PSJRetroMagazineContainer(Container):
    """A PSJ Magazine Container.
    """
    grok.implements(IPSJRetroMagazineContainer)
    ...
    psj_title = FieldProperty(IPSJRetroMagazineContainer["psj_title"])
    psj_subtitle = FieldProperty(IPSJRetroMagazineContainer["psj_subtitle"])
    ...
    def SearchableText(self):
        ...
        searchable text.
        """
        base_result = super(PSJRetroMagazineContainer, self).SearchableText()
